<template>
    ...
    <div class="carousel-container bg-background container" style="margin-top: -30px;">
      <v-btn
      ...
      <div class="cards-wrapper">
        ...
        >
          ...
          <div class="card-footer pa-4">
            <span class="text-white text-subtitle-1 d-block text-center">{{ card.title }}</span>
            <div class="d-flex align-center mt-1 justify-center mx-auto">
              <v-icon color="primary" size="small" class="mr-1 text-center">mdi-heart</v-icon>
              <span class="text-white text-center text-underline">{{ card.price }}</span>
            </div>
          </div>
        </v-card>
      </div>
...
const getCardClass = (index) => {
  const position = (index - currentIndex.value + totalPages.value) % totalPages.value;
